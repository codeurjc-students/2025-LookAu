...
public class PrimitivaDTO{
    ...
    public PrimitivaDTO(Long id, Integer num1, Integer num2, Integer num3, Integer num4, Integer num5, Integer num6, Integer reimbursement){
        this.id = id;
        this.num1 = num1;
        this.num2 = num2;
        this.num3 = num3;
