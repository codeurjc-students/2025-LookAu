...
@Entity
@DiscriminatorValue("PRIMITIVA")
public class Primitiva extends TicketType {
    ...
    public Primitiva(Integer num1, Integer num2, Integer num3, Integer num4, Integer num5, Integer num6, Integer reimbursement){
    ...
    public Primitiva(List<Integer> numbers){
        ...
        this.reimbursement = numbers.get(6);
    }
