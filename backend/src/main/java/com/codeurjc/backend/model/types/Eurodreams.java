...
public class Eurodreams extends TicketType {
    ...
    public Eurodreams(Integer num1, Integer num2, Integer num3, Integer num4, Integer num5, Integer num6, Integer dream){
    ...
    public Eurodreams(List<Integer> numbers){
        super(EnumTickectType.EURODREAMS);
